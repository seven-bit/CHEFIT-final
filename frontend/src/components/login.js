...
function Login(props){
  ...
  useEffect(() => { 
     ...
     axios.post('http://localhost:5000/api/users/login',information).then(res=>{ res.data.success === true?  sendData(res.data): alert("Wrong Email or Password")}).catch(err=>{console.log(err.response.data)})
   }, [information])
